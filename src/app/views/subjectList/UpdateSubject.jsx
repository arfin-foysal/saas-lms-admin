...
import { useGetClassListQuery, useSubjectCreateOrUpdateMutation } from "../../../services/contentApi";
const UpdateSubject = ({ handleClose,paramValue }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            ...
            resetForm();
            try {
                const result = await subjectCreateOrUpdate(formData).unwrap();
