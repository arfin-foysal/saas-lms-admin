...
import CreateClass from "./CreateStudentParticipants";
import UpdateClass from "./UpdateStudentParticipants";

const StudentParticipantsModal = ({ handleClose, show, clickValue, paramValue,size }) => {
    return (
        <>
...
export default React.memo(StudentParticipantsModal);
